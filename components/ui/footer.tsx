    ...
    <footer>
      <div className="py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          {/* Top area: Blocks */}
          {false && (<div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; REQOX Todos los derechos reservados</div>
