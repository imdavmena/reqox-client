      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h1 mb-4" data-aos="fade-up">¿Cómo nació nuestra plataforma REQOX?</h1>
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">
              Somos una empresa ubicada en la vibrante ciudad de Mumbai, Maharashtra. En tiempos de la pandemia del COVID-19, hemos sido testigos de la lamentable pérdida de empleos y del impacto económico que ha afectado a nuestro país.
            </p>
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">
              Como todos sábemos cuando nos encontramos desempleados en nuestros hogares, es común que pasemos horas viendo videos en nuestros teléfonos. Es en este contexto que los videos cortos han conquistado rápidamente la popularidad a nivel mundial.
            </p>
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">
              La plataforma de Reqox se ha concebido con el propósito principal de brindar apoyo a las empresas para que puedan promocionarse exitosamente. Además, se ha convertido en un valioso recurso para que los bloggers incrementen su visibilidad y así enfrentar la presión social relacionada con el desempleo.
            </p>
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">
              Para lograr un mayor impacto en plataformas como YouTube, TikTok y Facebook, hemos desarrollado la capacidad de enviar anuncios de productos altamente específicos a los espectadores, facilitando así la rápida venta de los mismos. Estos factores son los impulsores fundamentales del vertiginoso crecimiento que experimenta nuestra plataforma.
            </p>
          ...
          <ModalVideo
            ...
            videoHeight={1080}
          />
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16 mt-10">
            <h1 className="h1 mb-4" data-aos="fade-up">¿Con quiénes colabora la plataforma y de qué manera permite que los usuarios generen ingresos?</h1>
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">
              Dado que nos encontramos en la era digital, se presenta una situación en la que todos pueden beneficiarse. En este contexto, la industria de los videos cortos en línea está experimentando un rápido crecimiento.

            </p>
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">
              Los creadores de contenido en plataformas como YouTube, Facebook y TikTok necesitan aumentar su audiencia y visibilidad.
              Una vez que hayan desarrollado una base sólida de seguidores, podrán recibir anuncios y colaborar con empresas para promocionar y vender productos.
            </p>
            {/* <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
              <div data-aos="fade-up" data-aos-delay="400">
                <a className="btn text-white bg-purple-600 hover:bg-purple-700 w-full mb-4 sm:w-auto sm:mb-0" href="#0">Start free trial</a>
